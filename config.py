...
data_dir = '/home/jschen/wilduv_model'
result_dir = '/home/jschen/TBGAN_saved'
...
desc += '-wild_uv';            dataset = EasyDict(tfrecord_dir='tf_records',dynamic_range=[-1,1],dtype = 'float32');
G.lod_sep = 7
D.lod_sep = 7
